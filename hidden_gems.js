let locations = {
    data: [
      {
        locationName: "Anafiotika",
        category: "Nature park",
        image: "Pictures/anafiotika.png",
      },
      {
        locationName: "Colosseum",
        category: "Sights & Landmarks",
        image: "Pictures/colosseum.png",
      },
    ],
  };
  ...
  for (let i of locations.data) {
    ...
    name.innerText = i.locationName.toUpperCase();
  ...
  document.getElementById("search").addEventListener("click", () => {
    ...
    let elements = document.querySelectorAll(".location-name");
